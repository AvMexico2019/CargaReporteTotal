...
/****** Object:  Table [dbo].[ReporteToTal]    Script Date: 11/11/2019 04:53:32 p. m. ******/
SET ANSI_NULLS ON
GO
...
IF OBJECT_ID ('dbo.ReporteTotal', 'U') IS NOT NULL  
   DROP TABLE dbo.ReporteTotal;  

CREATE TABLE [dbo].[ReporteTotal](
	[NumeroSecuencial] [INT] identity(1,1),
	[Id] [int] NOT NULL,
